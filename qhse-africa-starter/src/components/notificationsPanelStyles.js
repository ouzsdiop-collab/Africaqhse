...
.notif-item{display:grid;grid-template-columns:auto 1fr auto;gap:12px;align-items:start;padding:12px 14px;border-radius:14px;border:1px solid var(--color-border-tertiary);background:var(--surface-3);position:relative;overflow:hidden}
...
.notif-prio-tag--low{background:var(--surface-4);color:var(--text-secondary);border:1px solid var(--color-border-tertiary)}
...
.notif-panel__filter-btn{
  padding:6px 12px;border-radius:999px;border:1px solid var(--color-border-tertiary);
  background:var(--surface-3);color:var(--text2);font-size:11px;font-weight:700;
  cursor:pointer;transition:background .15s ease,border-color .15s ease,color .15s ease;
}
.notif-panel__filter-btn:hover{color:var(--text);border-color:var(--color-border-secondary,var(--color-border))}
.notif-panel__filter-btn--active{
  background:var(--color-info-bg);border-color:var(--color-info-border);color:var(--color-info-text);
}
...
.notif-tier-tag--critique{background:var(--color-danger-bg);color:var(--color-danger-text);border:1px solid var(--color-danger-border)}
.notif-tier-tag--attention{background:var(--color-warning-bg);color:var(--color-warning-text);border:1px solid var(--color-warning-border)}
.notif-tier-tag--info{background:var(--surface-4);color:var(--text-secondary);border:1px solid var(--color-border-tertiary)}
.notif-tier-tag--digest{background:color-mix(in srgb,var(--color-violet) 14%,var(--surface-2));color:var(--color-violet-ink);border:1px solid color-mix(in srgb,var(--color-violet-border) 35%,var(--color-border))}

.notif-group-badge{
  font-size:10px;font-weight:700;padding:2px 8px;border-radius:999px;
  background:var(--surface-3);color:var(--text3);border:1px solid var(--color-border-tertiary);
}
...
.notif-panel__digest-kicker{
  ...
  background:color-mix(in srgb,var(--color-violet) 14%,var(--surface-2));color:var(--color-violet-ink);
  border:1px solid color-mix(in srgb,var(--color-violet-border) 30%,var(--color-border));
}
.notif-panel__digest-title{font-size:14px}
.notif-panel__digest-hint{font-size:11px;font-weight:600;color:var(--text3)}
.notif-panel__digest-body{margin-top:10px;padding-top:10px;border-top:1px solid var(--color-border-tertiary)}
