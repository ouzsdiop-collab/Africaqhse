    ...
    <article class="content-card card-soft dashboard-essential-pilotage__card">
      ...
      <div class="dashboard-essential-pilotage__grid">
        <article class="dashboard-essential-pilotage__mini-card">
          <div class="dashboard-essential-pilotage__mini-head"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1"/></svg>Priorités</div>
        ...
        <article class="dashboard-essential-pilotage__mini-card">
          <div class="dashboard-essential-pilotage__mini-head"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>Alertes critiques</div>
        ...
        <article class="dashboard-essential-pilotage__mini-card">
          <div class="dashboard-essential-pilotage__mini-head"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>Actions recommandées</div>
