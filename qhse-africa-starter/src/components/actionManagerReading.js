...
.action-manager-reading__kicker{font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--text3)}
.action-manager-reading__title{margin:4px 0 0;font-size:15px;font-weight:800;color:var(--text)}
.action-manager-reading__reco{margin:8px 0 0;font-size:12px;line-height:1.45;color:var(--text2);max-width:72ch}
...
.action-manager-reading__tile{
  ...
  background:rgba(0,0,0,.18);text-align:left;cursor:pointer;font:inherit;color:inherit;
  transition:border-color .15s ease,background .15s ease;
}
.action-manager-reading__tile:hover:not(:disabled){border-color:rgba(59,130,246,.4);background:rgba(0,0,0,.25)}
.action-manager-reading__tile:disabled{opacity:.55;cursor:default}
.action-manager-reading__tile-lbl{display:block;font-size:9px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:var(--text3);margin-bottom:6px}
.action-manager-reading__tile-val{font-size:13px;font-weight:700;color:var(--text);line-height:1.3}
.action-manager-reading__tile-sub{display:block;margin-top:4px;font-size:10px;color:var(--text3);line-height:1.35}
`;
