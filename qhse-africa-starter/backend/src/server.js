...
import equipmentSignalementRouter from './routes/equipmentSignalement.routes.js';
import environmentalRouter from './routes/environmental.routes.js';
import nearMissRouter from './routes/nearMiss.routes.js';
...
app.use('/api/equipment-signalements', equipmentSignalementRouter);
